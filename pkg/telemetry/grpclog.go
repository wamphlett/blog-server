...
// "failed to create fsnotify watcher" carry a proper log level in structured logs.
func SetGRPCLogger() {
...
func (g *grpcSlogLogger) Infof(format string, args ...interface{})    { slog.Info(fmt.Sprintf(format, args...)) }
...
func (g *grpcSlogLogger) Warningf(format string, args ...interface{}) { slog.Warn(fmt.Sprintf(format, args...)) }
...
func (g *grpcSlogLogger) Errorf(format string, args ...interface{})   { slog.Error(fmt.Sprintf(format, args...)) }
